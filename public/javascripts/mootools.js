...
}});Element.extend({effect:function(B,A){return new Fx.Style(this,B,A);}});var Json={toString:function(C){switch($type(C)){case"string":return'"'+C.replace(/(["\\])/g,"\\$1")+'"';
...
}return A;}});function $H(A){return new Hash(A);}